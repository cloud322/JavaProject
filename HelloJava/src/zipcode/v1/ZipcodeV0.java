...
public class ZipcodeV0 {
		...
		public ZipcodeV0(String 우편번호, String 시도, String 시군구, String 읍면, String 도로명, String 건물번호본번, String 건물번호부번,
		...
		public String toString() {
			return "ZipcodeV0 [우편번호=" + 우편번호 + ", 시도=" + 시도 + ", 시군구=" + 시군구 + ", 읍면=" + 읍면 + ", 도로명=" + 도로명
					+ ", 건물번호본번=" + 건물번호본번 + ", 건물번호부번=" + 건물번호부번 + ", 시군구용건물명=" + 시군구용건물명 + ", 법정동명=" + 법정동명 + ", 리명="
					+ 리명 + ", 지번본번=" + 지번본번 + "]";
		}
